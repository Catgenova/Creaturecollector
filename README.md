...
Fusion Lab tab and now lives at the overworld's shrine. Choosing the first
creature narrows the pool to what can actually pair with it — a fusion needs
two of the same class — and Clear puts the whole pool back; a Wild-only
toggle narrows it further to creatures born as a species, hiding everything
the shrine has already made.
