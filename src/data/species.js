...
export const SPECIES = [
  {
    id: 'pufflet', name: 'Pufflet', nameParts: ['Puff', 'let'], types: ['Normal'], tier: 'common', bst: 420,
  ...
  {
    id: 'finnip', name: 'Finnip', nameParts: ['Fin', 'nip'], types: ['Water'], tier: 'common', bst: 405,
  ...
  {
    id: 'sprigget', name: 'Sprigget', nameParts: ['Sprig', 'get'], types: ['Grass'], tier: 'common', bst: 430,
  ...
  {
    id: 'glacub', name: 'Glacub', nameParts: ['Gla', 'cub'], types: ['Ice'], tier: 'uncommon', bst: 440,
  ...
  {
    id: 'bruxor', name: 'Bruxor', nameParts: ['Brux', 'or'], types: ['Fighting'], tier: 'uncommon', bst: 420,
  ...
  {
    id: 'slugmire', name: 'Slugmire', nameParts: ['Slug', 'mire'], types: ['Poison'], tier: 'common', bst: 405,
  ...
  {
    id: 'mystril', name: 'Mystril', nameParts: ['Mys', 'tril'], types: ['Psychic'], tier: 'uncommon', bst: 430,
  ...
  {
    id: 'chitterbug', name: 'Chitterbug', nameParts: ['Chitter', 'bug'], types: ['Bug'], tier: 'common', bst: 410,
  ...
  {
    id: 'craggon', name: 'Craggon', nameParts: ['Crag', 'gon'], types: ['Rock'], tier: 'uncommon', bst: 445,
  ...
  {
    id: 'drakelet', name: 'Drakelet', nameParts: ['Drake', 'let'], types: ['Dragon'], tier: 'rare', bst: 465,
  ...
  // Dual-typed species
  {
    id: 'moltrix', name: 'Moltrix', nameParts: ['Mol', 'trix'], types: ['Fire', 'Flying'], tier: 'uncommon', bst: 435,
  ...
  {
    id: 'tidalisk', name: 'Tidalisk', nameParts: ['Tida', 'lisk'], types: ['Water', 'Dragon'], tier: 'rare', bst: 475,
  ...
  {
    id: 'mossbrute', name: 'Mossbrute', nameParts: ['Moss', 'brute'], types: ['Grass', 'Fighting'], tier: 'uncommon', bst: 455,
  ...
  {
    id: 'gloamoth', name: 'Gloamoth', nameParts: ['Gloa', 'moth'], types: ['Bug', 'Ghost'], tier: 'uncommon', bst: 415,
  ...
  // Batch two
  {
    id: 'bramblit', name: 'Bramblit', nameParts: ['Bram', 'blit'], types: ['Grass', 'Bug'], tier: 'common', bst: 425,
  ...
  {
    id: 'cinderhoof', name: 'Cinderhoof', nameParts: ['Cinder', 'hoof'], types: ['Fire', 'Ground'], tier: 'uncommon', bst: 435,
  ...
  {
    id: 'glimmerfin', name: 'Glimmerfin', nameParts: ['Glimmer', 'fin'], types: ['Water', 'Fairy'], tier: 'uncommon', bst: 415,
  ...
  {
    id: 'voltcrab', name: 'Voltcrab', nameParts: ['Volt', 'crab'], types: ['Electric', 'Steel'], tier: 'uncommon', bst: 440,
  ...
  {
    id: 'nightstalk', name: 'Nightstalk', nameParts: ['Night', 'stalk'], types: ['Poison', 'Dark'], tier: 'uncommon', bst: 415,
  ...
  {
    id: 'halowl', name: 'Halowl', nameParts: ['Hal', 'owl'], types: ['Psychic', 'Flying'], tier: 'rare', bst: 470,
