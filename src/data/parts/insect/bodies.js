...
import { L, SH, HL, fur } from '../_dsl.js';
...
export const I_BODIES = [
  iBody({
    ...
    extra: [L('M18,-19 C15,-8 15,4 20,13', 'k', 1.6, { op: 0.35 })],
    sockets: {
  ...
  iBody({
    ...
    extra: [L('M2,-19 C0,-8 0,4 4,13', 'k', 1.6, { op: 0.35 })],
    sockets: {
  ...
  iBody({
    ...
    extra: [L('M8,-12 C4,-4 -2,0 -8,2', 'k', 1.4, { op: 0.3 })],
    sockets: {
  ...
  iBody({
    ...
    extra: [L('M-14,-3 L-14,5 M-26,-3 L-26,5 M-38,-2 L-38,4 M-50,-1 L-50,3', 'k', 1.2, { op: 0.3 })],
    sockets: {
