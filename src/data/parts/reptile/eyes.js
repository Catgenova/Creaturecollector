...
function rEye({ id, name, shape, sclera = 'w', iris = [0.8, 0.2, 3.8], irisRole = 'e', pupil = [1.2, 0.5, 2], pupilPath, glint = [2.2, -1.8, 1.3], glint2 = [-1, 1.8, 0.7], lid, lidFill, before = [], dom = 0.5, w = 2, tags = [] }) {
  const prims = [...before];
  ...
  return rPart({ id, slot: 'eyes', name, tags, dom, w, extra: prims });
}
...
export const R_EYES = [
  ...
  rEye({ id: 'turret', name: 'Turret', tags: ['chameleon'], w: 2, shape: null, before: [C(0, 0, 8, 'p'), L('M-5,-5 C-2,-2 2,-2 5,-5 M-6,2 C-2,4 2,4 6,2', 'k', 1, { op: 0.3 })], iris: [1.5, 0, 3.4], pupil: [2, 0, 1.4], glint: [2.8, -1.4, 0.8], glint2: null }),
  rEye({ id: 'fierce', name: 'Fierce', tags: ['angry'], w: 2, shape: spline([[-6.5, -4], [0, -5.5], [6.5, -2], [6.5, 3], [2, 5.5], [-4, 5], [-7, 1]]), iris: [1, 0.6, 3.6], pupil: [1.4, 0.9, [1.4, 3.2]], glint: [2.4, -1, 1.1], lidFill: 'M-9,-10 L9,-10 L9,-1.5 L-9,-5.8 Z', lid: 'M-7,-5.5 L6.5,-1.5' }),
  rEye({ id: 'hooded', name: 'Hooded', tags: ['calm'], w: 2, shape: OVAL, iris: [0.8, 1.2, 3.8], pupil: [1.2, 1.5, 2], glint: [2.2, -0.4, 1.1], glint2: null, lidFill: 'M-9,-10 L9,-10 L9,-1 L-9,-1 Z', lid: 'M-6,-1 L6,-1' }),
  rEye({ id: 'bead', name: 'Bead', tags: ['small'], w: 3, shape: spline([[0, -5], [4.8, -1.5], [4.2, 3.6], [0, 5.2], [-4.2, 3.6], [-4.8, -1.5]]), iris: [0.4, 0, 4.4], pupil: [0.6, 0.2, 3.2], glint: [1.8, -1.8, 1.2], glint2: [-1, 1.5, 0.6], lid: null }),
