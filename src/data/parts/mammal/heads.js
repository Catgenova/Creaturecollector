...
import { fur, PATCH, SH, HL, L } from '../_dsl.js';

export const M_HEADS = [
  mPart({
    id: 'fox', slot: 'head', name: 'Vulpine', tags: ['fox'], dom: 0.55, w: 3,
    shapes: [[[-8, -42], [8, -45], [22, -40], [31, -30], [39, -16, 'c'], [35, -8], [22, -3], ...fur([10, 0], [-16, -8], 3, 5, { lean: 0.35 }), [-23, -20], [-20, -34]]],
    extra: [
  ...
  mPart({
    ...
    shapes: [[[-10, -40], [6, -45], [20, -40], [28, -30], [32, -18], [28, -8], [18, -2], ...fur([10, 0], [-18, -4], 3, 4, { lean: 0.3 }), [-26, -16], [-24, -30]]],
    extra: [
  ...
  mPart({
    ...
    shapes: [[[-14, -36], [4, -44], [20, -40], [28, -28], [34, -16], [34, -6], [26, 2], [10, 6], [-8, 4], [-20, -6], [-24, -22]]],
    extra: [
  ...
  mPart({
    ...
    shapes: [[[-10, -42], [6, -46], [20, -42], [30, -32], [40, -20], [46, -12, 'c'], [42, -6], [30, -2], ...fur([16, 0], [-16, -6], 3, 5, { lean: 0.35 }), [-24, -18], [-22, -32]]],
    extra: [
