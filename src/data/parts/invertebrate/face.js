...
function vEye({ id, name, shape, sclera = 'w', iris = [0.8, 0.2, 3.8], irisRole = 'e', pupil = [1.2, 0.5, 2], glint = [2.2, -1.8, 1.3], glint2 = [-1, 1.8, 0.7], lid, before = [], after = [], dom = 0.5, w = 2, tags = [] }) {
  const prims = [...before];
  ...
  prims.push(...after);
  return vPart({ id, slot: 'eyes', name, tags, dom, w, extra: prims });
}
...
export const V_EYES = [
  vEye({ id: 'stalks', name: 'Eyestalks', tags: ['slug'], w: 3, shape: null, before: stalkUp(18), iris: null, pupil: null, glint: null, glint2: null, after: [C(4, -20, 5, 'w', { sw: 2 }), C(4.8, -19.6, 3, 'e', { ns: true }), C(5.4, -19.4, 1.6, 'k', { ns: true }), C(6.4, -21.4, 1, 'w', { ns: true })] }),
  ...
  vEye({ id: 'hollow', name: 'Hollow', tags: ['ghost'], w: 2, shape: spline([[0, -7], [6, -3], [5, 5], [0, 7.5], [-5, 5], [-6, -3]]), sclera: 'k', iris: null, pupil: null, glint: [1.5, -1, 1.5], glint2: null, after: [C(1, 1, 2.2, 'e', { ns: true, op: 0.8 })] }),
  ...
  vEye({ id: 'stalked', name: 'Stalked', tags: ['crab'], w: 2, shape: null, before: [...tendril('M0,4 L1,-8', 4)], iris: null, pupil: null, glint: null, glint2: null, after: [C(1, -12, 5, 'w', { sw: 2 }), C(1.8, -11.6, 3, 'k', { ns: true }), C(3, -13.2, 1.1, 'w', { ns: true })] }),
];
