...
export const V_BODIES = [
  vBody({
    ...
    extra: [L('M-44,6 C-20,8 8,9 30,6', 'k', 1.4, { op: 0.3 }), L('M-10,-3 C-6,2 0,2 4,-4', 'k', 1.1, { op: 0.2 })],
    sockets: {
  ...
  vBody({
    ...
    extra: [L('M-30,-8 C-14,-14 14,-14 30,-8', 'k', 1.4, { op: 0.3 }), L('M-24,-2 C-8,2 8,2 24,-2', 'k', 1.1, { op: 0.2 })],
    sockets: {
  ...
  vBody({
    ...
    extra: [L('M-26,4 C-14,10 14,10 26,4', 'k', 1.2, { op: 0.25 }), L('M-8,-20 C-6,-8 -6,0 -4,6 M8,-20 C6,-8 6,0 4,6', 'k', 1, { op: 0.15 })],
    sockets: {
  ...
  vBody({
    ...
    extra: [L('M-34,-4 L-34,10 M-22,-8 L-22,12 M-10,-10 L-10,13 M4,-12 L4,13', 'k', 1.2, { op: 0.3 })],
    sockets: {
