...
export const V_PATTERNS = [
  NONE('pattern', 0.3, 'v.'),
  vPart({ id: 'spots', slot: 'pattern', name: 'Spots', tags: ['spotted'], dom: 0.5, w: 3, extra: [...[[-30, -12, 5], [-10, -22, 4], [10, -14, 5.5], [30, -20, 4], [-20, 6, 4], [4, 4, 3.5], [24, 4, 4.5], [-38, 8, 3]].map(([x, y, r]) => ({ t: 'ellipse', cx: x, cy: y, rx: r * 1.1, ry: r * 0.9, f: 'a', ns: true }))] }),
  vPart({ id: 'stripes', slot: 'pattern', name: 'Stripes', tags: ['striped'], dom: 0.5, w: 2, extra: [S([[-32, -40], [-20, -40], [-22, 40], [-34, 40]], 'a', { ns: true }), S([[-6, -40], [6, -40], [4, 40], [-8, 40]], 'a', { ns: true }), S([[20, -40], [32, -40], [30, 40], [18, 40]], 'a', { ns: true })] }),
  ...
  vPart({ id: 'gradient', slot: 'pattern', name: 'Dark back', tags: ['gradient'], dom: 0.5, w: 2, extra: [S([[-54, -40], [54, -40], [54, -12], [26, 0], [-8, 2], [-36, -2], [-56, -12]], 'a', { ns: true }), S([[-46, -40], [46, -40], [46, -26], [22, -16], [-6, -14], [-30, -18], [-48, -26]], 'k', { ns: true, op: 0.12 })] }),
];
