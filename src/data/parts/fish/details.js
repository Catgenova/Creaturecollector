...
export const F_PATTERNS = [
  NONE('pattern', 0.3, 'f.'),
  fPart({ id: 'stripes', slot: 'pattern', name: 'Stripes', tags: ['striped'], dom: 0.5, w: 3, extra: [S([[-30, -40], [-18, -40], [-20, 40], [-32, 40]], 'a', { ns: true }), S([[-4, -40], [8, -40], [6, 40], [-6, 40]], 'a', { ns: true }), S([[20, -40], [32, -40], [30, 40], [18, 40]], 'a', { ns: true })] }),
  ...
  fPart({ id: 'spots', slot: 'pattern', name: 'Spots', tags: ['spotted'], dom: 0.45, w: 2, extra: [...[[-30, -14, 5], [-12, -22, 4], [6, -16, 5.5], [24, -22, 4], [36, -10, 4.5], [-22, 2, 4], [-4, 6, 3.5], [16, 2, 4.5], [32, 10, 3.5], [-36, 10, 3]].map(([x, y, r]) => ({ t: 'ellipse', cx: x, cy: y, rx: r * 1.1, ry: r * 0.9, f: 'a', ns: true }))] }),
  ...
  fPart({ id: 'gradient', slot: 'pattern', name: 'Dark back', tags: ['gradient'], dom: 0.5, w: 2, extra: [S([[-52, -40], [52, -40], [54, -14], [26, 0], [-4, 4], [-32, 0], [-54, -14]], 'a', { ns: true }), S([[-44, -40], [44, -40], [44, -26], [20, -16], [-8, -14], [-30, -16], [-46, -26]], 'k', { ns: true, op: 0.12 })] }),
