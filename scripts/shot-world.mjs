// Headless check of the overworld: start a journey, pick a starter, walk, open the map, talk to a trainer.
// Usage: PLAYWRIGHT_BROWSERS_PATH=/opt/pw-browsers node scripts/shot-world.mjs [seed] -> shots/world-*.png
